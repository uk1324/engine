...
struct Gfx2d {
	...
	void filledRect(Vec2 center, Vec2 size, Vec4 color);
	void filledRectRotated(Vec2 center, Vec2 size, f32 angle, Vec3 color);
	void filledRectRotated(Vec2 center, Vec2 size, f32 angle, Vec4 color);
